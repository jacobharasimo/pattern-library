...
const vouchRelationship = (relationshipLevel, vouched) => {
  ...
  if (
    relationshipLevel > 0 &&
    relationshipLevel <= Object.keys(RELATIONSHIP_LEVEL_OPTIONS).length
  ) {
...
export const VouchPanel = forwardRef(
  ({ title, emptyMessage, vouches, isLoading }, ref) => (
          ...
          >
            ...
            <Popper
              popover={
                <Box>
                  <Text>
                    These are the people in your corner who recognize your
                    professional strengths and potential enough to put their
                    name behind you. When you are connected to other members in
                    your network, they will see who vouched for you and how they
                    know you. Queue a fantastic first impression!
                  </Text>
                </Box>
              }
            />
                    ...
                    return (
                      ...
                      >
                        ...
                        <Flex ml={3} flex={1} flexDirection="column">
                          ...
                          <Text
                            data-testid="relationship-level"
                            color="textDark"
                            fontStyle="italic"
                            my={2}
                          >
                            {vouchRelationship(
                              vouch.relationshipLevel,
                              vouch.vouched,
                            )}
                          </Text>
                          <Text data-testid="relationship-text">
                            {vouch.relationshipText}
                          </Text>
                        </Flex>
                      </Flex>
                    );
