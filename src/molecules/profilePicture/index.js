...
export const ProfilePicture = forwardRef(
  (
    { verifiedSize, imageUrl, name, variant, verified, ...rebassProps },
    ref,
  ) => {
            ...
            <Popper
              ...
              popover={
                <Box>
                  ...
                  <Text mt={3}>
                    Trusted people in the network have vouched for their
                    professional credibility giving them the ability to request
                    intros.
                  </Text>
                </Box>
              }
