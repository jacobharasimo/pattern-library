export const jobSourceStatus = {
  ...
  brand_new:
    'Our team is working on configuring this job source, which should take no more than 2 business days.',
  requires_verification:
    'Our team is reviewing an issue with the job source. It should be resolved within 2 business days. ',
  errored:
    'Our team detected an out of the ordinary issue with the job source. We are working hard to resolve this.',
  unidentifiable:
    'We cannot locate where this company post their jobs. Click Edit above to submit a valid job source.',
  bypassed:
